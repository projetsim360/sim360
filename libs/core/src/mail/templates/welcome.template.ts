...
<head>
  ...
  <title>Mot de passe réinitialisé - Sim360</title>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td style="text-align:center;padding:16px 0;">
              <a href="${loginUrl}" style="display:inline-block;background:#1B84FF;color:#fff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:600;font-size:16px;">
                Se connecter
              </a>
            </td>
          </tr>
