...
export function SignInPage() {
  ...
  return (
    <AuthCard
      title="Bon retour."
      subtitle="Continuez votre progression de PM."
      topSlot={googleButton}
      bottomSlot={
        <>
          Pas encore de compte ?{' '}
          <Link to="/auth/sign-up" className="font-medium text-[var(--accent-600)] hover:underline">
            Créer un compte
          </Link>
        </>
      }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-[14px] text-[var(--accent-600)] hover:underline font-medium"
            >
              Mot de passe oublié ?
            </Link>
          </div>
