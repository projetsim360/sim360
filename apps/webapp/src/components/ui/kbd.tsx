...
const kbdVariants = cva('inline-flex items-center justify-center font-mono rounded-md', {
  variants: {
    ...
    size: {
      md: 'h-7 min-w-7 px-1.5 text-xs [&_svg]:size-3.5 [&_i]:text-sm',
      sm: 'h-6 min-w-6 px-1 text-[0.75rem] leading-[0.75rem] [&_svg]:size-3 [&_i]:text-xs',
      xs: 'h-5 min-w-5 px-1 text-[0.6875rem] leading-[0.75rem] [&_svg]:size-3 [&_i]:text-xs',
    },
  },
  defaultVariants: {
    variant: 'default',
