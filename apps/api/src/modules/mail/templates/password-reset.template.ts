...
<head>
  ...
  <title>Réinitialisation de mot de passe - Sim360</title>
</head>
    ...
    <tr>
      <td style="padding:40px 32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td style="text-align:center;padding:16px 0;">
              <a href="${resetUrl}" style="display:inline-block;background:#1B84FF;color:#fff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:600;font-size:16px;">
        ...
        <p style="color:#94a3b8;font-size:13px;line-height:1.5;margin:24px 0 0;">
          Ce lien expire dans 1 heure. Si vous n'avez pas fait cette demande, ignorez cet email. Votre mot de passe reste inchangé.
        </p>
      </td>
    </tr>
    <tr>
