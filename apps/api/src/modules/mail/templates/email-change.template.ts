export function emailChangeTemplate(firstName: string, confirmUrl: string): string {
  return `
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Changement d'email - Sim360</title>
</head>
    ...
    <tr>
      <td style="padding:40px 32px;">
        ...
        <p style="color:#475569;line-height:1.6;margin:0 0 24px;">
          Vous avez demandé à changer votre adresse email sur Sim360. Cliquez sur le bouton ci-dessous pour confirmer ce changement.
        </p>
        <div style="text-align:center;margin:32px 0;">
          <a href="${confirmUrl}" style="background:#1B84FF;color:#fff;padding:14px 32px;border-radius:6px;text-decoration:none;font-weight:600;display:inline-block;">
